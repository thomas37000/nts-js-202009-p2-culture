...
<img className="photo"
    ...
    <section className="Card">
      <div className="information">
        ...
        <h4 className="accessibilité">Accessiblité : <i class="material-icons">accessible</i><i class="material-icons">hearing_disabled</i><i class="material-icons">child_friendly</i></h4>
        <h4 className="gratuité">Gratuité : <span>enfants et demandeurs d'emploi</span></h4>
      ...
      <div class="location">
        <div class="contact">
          ...
          <p><i class="material-icons">perm_phone_msg</i> <a class="contactLinks" href="tel:+33240415500">02 40 41 55 00</a></p>
          <p><i class="material-icons">email</i> <a class="contactLinks" href="mailto:contact@museum.com">contact@museum.com</a></p>
        </div>
        <div class="map">
        <iframe
